...
// curl -v -X POST http://127.0.0.1:8080/bookmarks -d '{"uri":"http://dave.dl.ac.uk", "description":"daves page"}' -H "Content-Type: application/json" -H "Authorization: Bearer 66953496-fc5b-44d0-9210-b0521863ffcb"
